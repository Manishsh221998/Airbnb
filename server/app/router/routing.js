...
//dashboard
router.get('/',AdminCheck,registerController.CheckAuth,dashboardController.dashboard)
...
router.post('/register/create',AdminImage.single('image'),registerController.registerCreate)
...
router.post('/create-property',mutileImages,PropertyController.createProperty)
