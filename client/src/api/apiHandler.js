...
export const resetPassword = (id, token, data) => axiosInstance.post(ENDPOINTS.RESET_PASSWORD(id, token), data);

// Profile
export const getProfile = () => axiosInstance.get(ENDPOINTS.PROFILE);
export const updatePassword = (data) => axiosInstance.post(ENDPOINTS.UPDATE_PASSWORD, data);

// Hotels
export const createHotel = (data) =>axiosInstance.post(ENDPOINTS.CREATE_HOTEL, data);

// Booking
export const createBooking = (data) => axiosInstance.post(ENDPOINTS.CREATE_BOOKING, data);
